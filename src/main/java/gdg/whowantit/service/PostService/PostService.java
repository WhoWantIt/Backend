...
public interface PostService {
    ...
    PostResponseDto.BeneficiaryPostResponseDto verifyApprovePost(Long postId);
    void verifyRejectPost(Long postId);
    PostResponseDto.BeneficiaryPostResponseDto updatePostExel(Long postId);
}
